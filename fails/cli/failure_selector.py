...
class FailureColumnSelector:
    ...
    def _display_column_selection(self) -> bool:
        ...
        write_line()
        write_line("  ╭" + "─" * 92 + "╮")
        write_line("  │  \033[1;96mStep 3: Create Trace Filter\033[0m" + " " * 63 + "│")
        write_line("  │" + " " * 92 + "│")
        write_line("  │  \033[1m3a. Column Selection\033[0m" + " " * 70 + "│")
        write_line("  │" + " " * 92 + "│")
        write_line("  │  Select the 1 column that identifies the traces you want to analyze." + " " * 24 + "│")
        ...
        write_line("  │  - The pattern analysis will use this column to filter the traces to focus on." + " " * 12 + "│")
        write_line("  │" + " " * 92 + "│")
    ...
    def _display_confirmation(self) -> bool:
        ...
        write_line("  │" + " " * 92 + "│")
        write_line("  │  Please confirm this filter identifies the traces you want to analyze:" + " " * 21 + "│")
        write_line("  │" + " " * 92 + "│")
        ...
        # Additional context
        write_line("  \033[2mThis filter will be used to identify traces for pattern analysis.\033[0m")
        write_line("  \033[2mMake sure this correctly identifies the traces you want to categorize.\033[0m")
